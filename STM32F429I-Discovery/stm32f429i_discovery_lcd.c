...
{ 
  ...
  LTDC_InitStruct.LTDC_BackgroundRedValue = 218;            
  LTDC_InitStruct.LTDC_BackgroundGreenValue = 249;          
  LTDC_InitStruct.LTDC_BackgroundBlueValue = 173;  
...
/**
  ...
  * @retval None
  */
void LCD_DisplayStringLine(uint16_t Line, char *ptr)
{  
  uint16_t refcolumn = 20;
  /* Send the string character by character on lCD */
